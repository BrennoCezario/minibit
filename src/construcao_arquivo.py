...
class ConstruirArquivo:
    ...
    def construir_arquivo(self, peer_id):
        ...
        blocos_ordenados_b64 = self.ordenar_blocos_por_hash(self.blocos_arquivo)
    ...
    def verifica_construcao(self):
        ...
        for idx, (bloco_b64, original_hash) in enumerate(zip(self.blocos_arquivo, self.metadata["hash_blocos"])):
            bloco = base64.b64decode(bloco_b64)
