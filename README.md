...
**• Pedro Paulo:**
Embora ja tivesse trabalhado com um sistema P2P, era usando websocket e fazia a manutenção e não a implementação, foi bem dificil inciamente de entender como os peers e tracker iam se comunicar e interagir um com os outros, foi muito interessante aprender os conceitos e ve-los sendo colocados em prática.