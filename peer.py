...
import struct
import os
from divisao_blocos import divide_arquivo_gera_hash
from construcao_arquivo import construir_arquivo, verifica_construcao
...
class Peer:
    ...
    def start_download(self):
        ...
        construir_arquivo(blocos_ordenados, output)

        if verifica_construcao(self.hashes, blocos_ordenados):
